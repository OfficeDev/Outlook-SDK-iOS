...
- (instancetype) initWithDictionary: (NSDictionary *) dic {
    if((self = [self init])) {
        if(dic!=nil) {
		_response = (![dic objectForKey: @"Response"] || [ [dic objectForKey: @"Response"] isKindOfClass:[NSNull class]] )?_response:[MSOutlookResponseTypeSerializer fromString:[dic objectForKey: @"Response"]];
...
- (NSDictionary *) toDictionary {
	...
	{[dic setValue: [MSOutlookResponseTypeSerializer toString:self.response] forKey: @"Response"];}
