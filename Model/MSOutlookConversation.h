...
#ifndef MSOUTLOOKCONVERSATION_H
#define MSOUTLOOKCONVERSATION_H
...
/** Interface MSOutlookConversation
 *
 */
@interface MSOutlookConversation : MSOutlookEntity <MSOrcInteroperableWithDictionary>
