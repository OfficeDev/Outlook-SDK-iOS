...
/** Implementation for MSOutlookPhoto
 *
 */
@implementation MSOutlookPhoto
...
- (instancetype)init {
	...
	if (self = [super init]) {
		...
		_odataType = @"#Microsoft.OutlookServices.Photo";
...
- (NSDictionary *) toDictionary {
    ...
    [dic setValue: @"#Microsoft.OutlookServices.Photo" forKey: @"@odata.type"];
