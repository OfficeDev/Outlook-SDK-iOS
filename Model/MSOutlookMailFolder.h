...
#ifndef MSOUTLOOKMAILFOLDER_H
#define MSOUTLOOKMAILFOLDER_H
...
/** Interface MSOutlookMailFolder
 *
 */
@interface MSOutlookMailFolder : MSOutlookEntity <MSOrcInteroperableWithDictionary>
