...
- (instancetype) initWithDictionary: (NSDictionary *) dic {
    if((self = [self init])) {
        if(dic!=nil) {
		_pattern = (![dic objectForKey: @"Pattern"] || [ [dic objectForKey: @"Pattern"] isKindOfClass:[NSNull class]] )?_pattern:[[MSOutlookRecurrencePattern alloc] initWithDictionary: [dic objectForKey: @"Pattern"]];
		_range = (![dic objectForKey: @"Range"] || [ [dic objectForKey: @"Range"] isKindOfClass:[NSNull class]] )?_range:[[MSOutlookRecurrenceRange alloc] initWithDictionary: [dic objectForKey: @"Range"]];
    }
