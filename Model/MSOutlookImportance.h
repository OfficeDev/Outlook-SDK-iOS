...
#ifndef MSOUTLOOKIMPORTANCE_H
#define MSOUTLOOKIMPORTANCE_H
...
typedef NS_ENUM(NSInteger, MSOutlookImportance) {
    ...
    /** Enum entry MSOutlookImportanceLow
     * */
    MSOutlookImportanceLow,
    /** Enum entry MSOutlookImportanceNormal
     * */
    MSOutlookImportanceNormal,
    /** Enum entry MSOutlookImportanceHigh
     * */
