...
- (instancetype) initWithDictionary: (NSDictionary *) dic {
    if((self = [self init])) {
        if(dic!=nil) {
		_type = (![dic objectForKey: @"Type"] || [ [dic objectForKey: @"Type"] isKindOfClass:[NSNull class]] )?_type:[MSOutlookRecurrencePatternTypeSerializer fromString:[dic objectForKey: @"Type"]];
		...
		_firstDayOfWeek = (![dic objectForKey: @"FirstDayOfWeek"] || [ [dic objectForKey: @"FirstDayOfWeek"] isKindOfClass:[NSNull class]] )?_firstDayOfWeek:[MSOutlookDayOfWeekSerializer fromString:[dic objectForKey: @"FirstDayOfWeek"]];
		_index = (![dic objectForKey: @"Index"] || [ [dic objectForKey: @"Index"] isKindOfClass:[NSNull class]] )?_index:[MSOutlookWeekIndexSerializer fromString:[dic objectForKey: @"Index"]];
    }
...
- (NSDictionary *) toDictionary {
	...
	{[dic setValue: [MSOutlookRecurrencePatternTypeSerializer toString:self.type] forKey: @"Type"];}
    ...
    for(id obj in self.daysOfWeek) {
       [curVal addObject:[MSOutlookDayOfWeekSerializer toString:obj]];
    }
    
    if([curVal count]==0) curVal=nil;
if (curVal!=nil) [dic setValue: curVal forKey: @"DaysOfWeek"];}
	{[dic setValue: [MSOutlookDayOfWeekSerializer toString:self.firstDayOfWeek] forKey: @"FirstDayOfWeek"];}
	{[dic setValue: [MSOutlookWeekIndexSerializer toString:self.index] forKey: @"Index"];}
...
- (NSDictionary *) toUpdatedValuesDictionary {
 ...
 if([self.updatedValues containsObject:@"Type"])
            ...
            { [dic setValue: [MSOutlookDayOfWeekSerializer toString:self.daysOfWeek] forKey: @"DaysOfWeek"];
