...
#ifndef MSOUTLOOKGEOCOORDINATES_H
#define MSOUTLOOKGEOCOORDINATES_H
...
/** Interface MSOutlookGeoCoordinates
 *
 */
@interface MSOutlookGeoCoordinates : MSOrcBaseEntity <MSOrcInteroperableWithDictionary>
