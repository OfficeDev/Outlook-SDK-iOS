...
#ifndef MSOUTLOOKCONVERSATIONTHREAD_H
#define MSOUTLOOKCONVERSATIONTHREAD_H
...
/** Interface MSOutlookConversationThread
 *
 */
@interface MSOutlookConversationThread : MSOutlookEntity <MSOrcInteroperableWithDictionary>
