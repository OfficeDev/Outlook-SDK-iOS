...
/** Implementation for MSOutlookReferenceAttachment
 *
 */
@implementation MSOutlookReferenceAttachment
...
- (instancetype)init {
	...
	if (self = [super init]) {
		...
		_odataType = @"#Microsoft.OutlookServices.ReferenceAttachment";
...
- (NSDictionary *) toDictionary {
    ...
    [dic setValue: @"#Microsoft.OutlookServices.ReferenceAttachment" forKey: @"@odata.type"];
