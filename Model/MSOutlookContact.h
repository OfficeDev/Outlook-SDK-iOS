 ...
 *
 */
@property (nonatomic,  copy, setter=setHomeAddress:, getter=homeAddress) MSOutlookPhysicalAddress * homeAddress;

/** Property businessAddress
 *
 */
@property (nonatomic,  copy, setter=setBusinessAddress:, getter=businessAddress) MSOutlookPhysicalAddress * businessAddress;
