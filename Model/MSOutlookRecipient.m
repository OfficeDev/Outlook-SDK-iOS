...
/** Implementation for MSOutlookRecipient
 *
 */
...
- (instancetype) initWithDictionary: (NSDictionary *) dic {
    if((self = [self init])) {
        if(dic!=nil) {
		_emailAddress = (![dic objectForKey: @"EmailAddress"] || [ [dic objectForKey: @"EmailAddress"] isKindOfClass:[NSNull class]] )?_emailAddress:[[MSOutlookEmailAddress alloc] initWithDictionary: [dic objectForKey: @"EmailAddress"]];
    }
...
- (NSDictionary *) toDictionary {
    ...
    [dic setValue: @"#Microsoft.OutlookServices.Recipient" forKey: @"@odata.type"];
 ...
 *
 */
- (void) setEmailAddress: (MSOutlookEmailAddress *) value {
    _emailAddress = value;
