...
@implementation MSOutlookImportanceSerializer
...
+(NSString *) toString: (MSOutlookImportance) value {
    ...
    {
        stringMappings=[[NSDictionary alloc] initWithObjectsAndKeys:
         @"Low", [NSNumber numberWithInt:MSOutlookImportanceLow], @"Normal", [NSNumber numberWithInt:MSOutlookImportanceNormal], @"High", [NSNumber numberWithInt:MSOutlookImportanceHigh],
            nil        
        ];
    }
