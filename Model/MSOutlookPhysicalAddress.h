...
#ifndef MSOUTLOOKPHYSICALADDRESS_H
#define MSOUTLOOKPHYSICALADDRESS_H
...
/** Interface MSOutlookPhysicalAddress
 *
 */
@interface MSOutlookPhysicalAddress : MSOrcBaseEntity <MSOrcInteroperableWithDictionary>
