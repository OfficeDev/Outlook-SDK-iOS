...
/** Implementation for MSOutlookPost
 *
 */
@implementation MSOutlookPost
...
- (instancetype)init {
	...
	if (self = [super init]) {
		...
		_odataType = @"#Microsoft.OutlookServices.Post";
    ...
    if((self = [self init])) {
        ...
        if([dic objectForKey: @"NewParticipants"] != [NSNull null]){
            ...
            for (id object in [dic objectForKey: @"NewParticipants"]) {
                [_newParticipants addObject:[[MSOutlookRecipient alloc] initWithDictionary: object]];
            }
		...
		_inReplyTo = (![dic objectForKey: @"InReplyTo"] || [ [dic objectForKey: @"InReplyTo"] isKindOfClass:[NSNull class]] )?_inReplyTo:[[MSOutlookPost alloc] initWithDictionary: [dic objectForKey: @"InReplyTo"]];
...
if (curVal!=nil) [dic setValue: curVal forKey: @"Categories"];}
    ...
    [dic setValue: @"#Microsoft.OutlookServices.Post" forKey: @"@odata.type"];
 ...
 *
 */
- (void) setInReplyTo: (MSOutlookPost *) value {
    _inReplyTo = value;
