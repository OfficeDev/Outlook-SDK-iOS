...
#ifndef MSOUTLOOKPOST_H
#define MSOUTLOOKPOST_H
...
/** Interface MSOutlookPost
 *
 */
@interface MSOutlookPost : MSOutlookItem <MSOrcInteroperableWithDictionary>
 ...
 *
 */
@property (nonatomic,  copy, setter=setInReplyTo:, getter=inReplyTo) MSOutlookPost * inReplyTo;
