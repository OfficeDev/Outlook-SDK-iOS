...
#ifndef MSOUTLOOKGROUPOPERATIONS_H
#define MSOUTLOOKGROUPOPERATIONS_H
...
/** MSOutlookGroupOperations
 *
 */
@interface MSOutlookGroupOperations : MSOutlookDirectoryObjectOperations
