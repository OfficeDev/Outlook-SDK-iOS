...
#ifndef MSOUTLOOKEVENTMESSAGECOLLECTIONFETCHER_H
#define MSOUTLOOKEVENTMESSAGECOLLECTIONFETCHER_H
...
/** MSOutlookEventMessageCollectionFetcher
 *
 */
...
- (void)add:(MSOutlookEventMessage *)entity callback:(void (^)(MSOutlookEventMessage *, MSOrcError *))callback;
