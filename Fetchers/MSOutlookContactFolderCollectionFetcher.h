...
#ifndef MSOUTLOOKCONTACTFOLDERCOLLECTIONFETCHER_H
#define MSOUTLOOKCONTACTFOLDERCOLLECTIONFETCHER_H
...
/** MSOutlookContactFolderCollectionFetcher
 *
 */
...
- (void)add:(MSOutlookContactFolder *)entity callback:(void (^)(MSOutlookContactFolder *, MSOrcError *))callback;
