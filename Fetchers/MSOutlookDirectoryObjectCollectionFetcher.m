...
@implementation MSOutlookDirectoryObjectCollectionFetcher

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {

    return [super initWithUrl:urlComponent parent:parent asClass:[MSOutlookDirectoryObject class]];
}

- (void)add:(MSOutlookDirectoryObject*)entity callback:(void (^)(MSOutlookDirectoryObject *mSOutlookDirectoryObject, MSOrcError *error))callback {
...
- (MSOutlookDirectoryObjectFetcher *)getById:(id) identifier {
    ...
    return [[MSOutlookDirectoryObjectFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" , identifier] parent:self];
}
