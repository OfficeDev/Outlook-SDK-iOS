...
#ifndef MSOUTLOOKMAILFOLDERCOLLECTIONOPERATIONS_H
#define MSOUTLOOKMAILFOLDERCOLLECTIONOPERATIONS_H
...
/** MSOutlookMailFolderCollectionOperations
 *
 */
@interface MSOutlookMailFolderCollectionOperations : MSOutlookEntityCollectionOperations
