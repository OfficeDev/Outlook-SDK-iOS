...
@implementation MSOutlookPostFetcher

@synthesize operations = _operations;

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {

    if (self = [super initWithUrl:urlComponent parent:parent asClass:[MSOutlookPost class]]) {

		_operations = [[MSOutlookPostOperations alloc] initOperationWithUrl:urlComponent parent:parent];
    }

    return self;
}

- (void)update:(id)entity callback:(void (^)(MSOutlookPost *Post, MSOrcError *e))callback {
...
- (void) readWithCallback:(void (^)(MSOutlookPost *Post, MSOrcError *error))callback {
    [super readWithCallback:^(id response, MSOrcError *error) {
        callback(response, error);
    }];
}

- (MSOutlookPostFetcher *)inReplyTo {

	 return [[MSOutlookPostFetcher alloc] initWithUrl:@"InReplyTo" parent:self asClass:[MSOutlookPost class]];
}
