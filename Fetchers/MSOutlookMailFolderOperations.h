...
#ifndef MSOUTLOOKMAILFOLDEROPERATIONS_H
#define MSOUTLOOKMAILFOLDEROPERATIONS_H
...
/** MSOutlookMailFolderOperations
 *
 */
@interface MSOutlookMailFolderOperations : MSOutlookEntityOperations
