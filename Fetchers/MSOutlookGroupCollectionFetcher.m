...
@implementation MSOutlookGroupCollectionFetcher

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {

    return [super initWithUrl:urlComponent parent:parent asClass:[MSOutlookGroup class]];
}

- (void)add:(MSOutlookGroup*)entity callback:(void (^)(MSOutlookGroup *mSOutlookGroup, MSOrcError *error))callback {
...
- (MSOutlookGroupFetcher *)getById:(id) identifier {
    ...
    return [[MSOutlookGroupFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" , identifier] parent:self];
}
